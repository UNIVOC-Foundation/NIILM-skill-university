      ...
      <div className="bg-gray-50 py-10 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            NIILM UNIVERSITY is a Non-Profit company under section 25 that was
            incorporated in the year 2012 and is supported by the Dudani Group
            of Companies with an annual turnover of 600+ crore. It provides
            exposure to mining, coal processing, iron & steel, real estate, and
            more. NIILM UNIVERSITY is a training partner for the National Skill
            Development Corporation (NSDC), impacting 1.2 lakh students through
            various initiatives.
          </p>
          <p className="text-gray-600 leading-relaxed">
            NIILM UNIVERSITYis empaneled with the Ministry of Skill Development
            and Entrepreneurship as a Third-Party Aggregator (TPA). Its CSR
            clients include Tata Consultancy Services (TCS), GE Healthcare,
            Emami Group, Whirlpool, Yes Bank, and more.
          </p>
        </div>
      </div>
