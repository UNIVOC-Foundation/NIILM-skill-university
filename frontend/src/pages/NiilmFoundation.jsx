    ...
    <div className="font-sans">
      ...
      <div className="bg-gray-50 py-10 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Medhavi Foundation</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Medhavi Foundation is a Non-Profit company under section 25 that was incorporated in the
            ...
            and more. Medhavi Foundation is a training partner for the National Skill Development
            Corporation (NSDC), impacting 1.2 lakh students through various initiatives.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Medhavi Foundation is empaneled with the Ministry of Skill Development and
