import CurricularComponents from "../../components/Academics/CurricularComponents";
      ...
      <section className="bg:none py-12 px-6">
        <div className=" mx-auto flex flex-col lg:flex-row items-center ">
          ...
          <div className="lg:w-1/2">
            <h1 className="text-2xl font-bold mb-4">At NIILM University</h1>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              ...
              the vibrant campus culture through involvement in student
              councils, events, festivals, and community service initiatives,
