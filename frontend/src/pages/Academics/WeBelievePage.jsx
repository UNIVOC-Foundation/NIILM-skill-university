  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            "url('https://www.msu.edu.in/frontend_assets/images/we-belive-img.png')",
        }}
      >
        ...
        <div className="lg:w-1/2 w-full text-left mb-8 lg:mb-0">
          ...
          <div className="bg-blue-600 text-white rounded-lg p-6 lg:p-8 shadow-lg">
            <p className="border-b border-blue-300 pb-3 mb-3">
              Education Can’t bring Employability without experience with
              Employers.
            </p>
            <p className="border-b border-blue-300 pb-3 mb-3">
            ...
            <p className="border-b border-blue-300 pb-3 mb-3">
              Education can nurture Responsibility with the Freedom to make
            ...
            <p>
              Education can’t bring life-readiness without challenging the zone
              of self-comfort.
            </p>
          </div>
        </div>
