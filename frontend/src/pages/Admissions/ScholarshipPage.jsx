        ...
        <div className="mx-auto w-4/5 py-12">
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="text-lg leading-10">
              <p className="mb-8">
                NIILM Skills University offers a wide range of scholarships and
                financial aid options to ensure that all students, regardless of
                their background, have access to quality education. For Indian
                States and Union Territories, scholarships based on entrance
                test performance are available, with varying percentages based
                on the score. NIILM ensures that financial constraints do not
                hinder access to education. Also, students through the
                initiative of Scholarship Cell are benefitting from various
                Government scholarship scheme for students of North Eastern
              ...
              <p>
                ...
                initiatives, NIILM remains committed to fostering inclusive
